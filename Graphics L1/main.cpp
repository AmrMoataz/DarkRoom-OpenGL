...
bool InitGraphics()
{
	...
	do{ // Loop
		...
		if (MouseXPos != WindowWidth / 2 || MouseYPos != WindowHeight / 2)
		{
			double mouseSensitivity = 0.005;
			double movedDistanceX = (WindowWidth / 2 - MouseXPos)*mouseSensitivity;
			double movedDistanceY = (WindowHeight / 2 - MouseYPos)*mouseSensitivity;
