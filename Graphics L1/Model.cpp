...
//void Model::ReverseNorms()
//{
//	for (int i = 0; i < NormalsData.size(); i++)
//	{
//		NormalsData[i] = NormalsData[i] * -1.0f;
//	}
//}
...
void Model::DrawStrip()
{
	...
	if (IndicesData.size() > 0)
	{
		glDrawElements(GL_TRIANGLE_STRIP, IndicesData.size(), GL_UNSIGNED_SHORT, 0);
	}
	else
	{
		//no indices provided.
